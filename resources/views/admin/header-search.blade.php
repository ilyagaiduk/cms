                ...
                <div class="col-lg-6">
                    ...
                    <script>
                        $(document).on("click", "#addRow", function (e) {
                            ...
                            $('#table > tbody:last-child').append('' +
                                ...
                                '                                </td>\n' +
                                '                                <td>\n' +
                                '                                    <input type="text" class="form-control" id="headerSearch' + rowCount + '" name="headerSearch' + rowCount + '">\n' +
                                '\n' +
                                '                                </td>\n' +
                                '                                <td>\n' +
                    ...
                    <form id="form" class="mt-5" method="post" action="{{ route('JsonConfig') }}">
                        ...
                        <table id="table" class="table-responsive table">
                            ...
                            @for($i = 1; $i <= 50; $i++)
                                @php($count++)
                                @if(empty($data->{'headerSearch'.$i}) && $i > 1)
                                    @php($count--)
                                    @continue
                                @elseif(empty($data->{'headerSearch'.$i}) && $i == 1)
                                    <tr>
                                        <td>
                                            1
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" id="headerSearch1"
                                                   name="headerSearch1" value="1">
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="headerSearch{{$i}}"
                                                   name="headerSearch{{$i}}" value="{{ $data->{'headerSearch'.$i} }}">
                        ...
                        <div class="mb-3">
                            <input type="hidden" id="filename" name="filename" value="config-header-search">
                        </div>
                        <div class="mb-3">
